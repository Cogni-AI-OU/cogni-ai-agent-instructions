...
2. **Skill & Instruction Loading**: Autonomously discover and load `copilot/copilot.instructions.md`, relevant `.instructions.md` rules, and applicable `SKILL.md` workflows.
